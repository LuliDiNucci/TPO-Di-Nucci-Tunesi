...
class ModeloVentas extends Modelo
{
    protected function _deploy()
    {
        ...
        if (count($tablas) == 0) {
            $ventas = [
                ['clave_foranea' => '1','fecha_compra' => '2024-10-17 17:38:24', 'monto' => '175000', 'producto' => 'Olympea', 'importado' => '0'],
                ['clave_foranea' => '1', 'fecha_compra' => '2024-10-17 17:38:24', 'monto' => '175000', 'producto' => 'Olympea', 'importado' => '0'],
                ['clave_foranea' => '2', 'fecha_compra' => '2024-10-17 22:39:21', 'monto' => '223740', 'producto' => 'good girl carolina herrera', 'importado' => '1'],
                ['clave_foranea' => '2', 'fecha_compra' => '2024-10-17 22:39:57', 'monto' => '185900', 'producto' => 'Giorgio Armani', 'importado' => '1'],
                ['clave_foranea' => '3', 'fecha_compra' => '2024-10-17 22:40:25', 'monto' => '161100', 'producto' => 'Emporio She- Giorgio Armani', 'importado' => '0'],
                ['clave_foranea' => '4', 'fecha_compra' => '2024-10-17 22:40:50', 'monto' => '166789', 'producto' => 'Gentelman Society- Giorgio Armani', 'importado' => '1'],
                ['clave_foranea' => '4', 'fecha_compra' => '2024-10-17 22:41:23', 'monto' => '153500', 'producto' => 'Chance- Chanel', 'importado' => '1'],
                ['clave_foranea' => '5', 'fecha_compra' => '2024-10-17 22:41:50', 'monto' => '154615', 'producto' => 'Flower by kenzo', 'importado' => '1']
            ...
            $sql = <<<SQL
                CREATE TABLE `ventas` (
                        ...
                        FOREIGN KEY (clave_foranea) REFERENCES clientes(id_cliente)
