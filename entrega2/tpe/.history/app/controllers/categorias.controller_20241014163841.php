...
class CategoriasController
{
    ...
    public function showCategoria($id_categoria){
        $clientes = $this->model->getCategoria($id_categoria);

        return $this->view->showCategoria($clientes);
    }
    ...
    public function eraseCategoria($id_categoria)
    {
        ...
        if (!$categoria) {
            return $this->view->showError("No existe la venta con el id_venta=$id_categoria");
        }
