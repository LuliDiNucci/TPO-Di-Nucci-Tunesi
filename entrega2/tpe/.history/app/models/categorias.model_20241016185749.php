 ...
 */
    ...
    public function updateCategoria($id_categoria, $nombre, $telefono, $mail, $fecha_nacimiento, $imagen) {
        // Asegúrate de que la fecha esté en el formato adecuado antes de la consulta.
        ...
        $query->execute([$nombre, $telefono, $mail, $fecha_nacimiento_formateada, $imagen, $id_categoria]);
    }
}
