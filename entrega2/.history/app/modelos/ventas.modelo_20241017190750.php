...
class ModeloVentas extends Model
{
    ...
    public function obetenerVenta($id_venta)
    {
    ...
    public function insertarVenta($claveForanea, $fecha_compra, $monto, $producto, $importado)
    {
            $query = $this->db->prepare('INSERT INTO ventas(clave_foranea, fecha_compra, monto, producto, importado) VALUES (?, ?, ?, ?, ?)');
            $query->execute([$claveForanea, $fecha_compra, $monto, $producto, $importado]);
