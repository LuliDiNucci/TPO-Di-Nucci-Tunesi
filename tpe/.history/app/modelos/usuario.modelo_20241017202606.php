...
class ModeloUsuario extends Modelo
{
    ...
    public function obtenerUsuarioPorNombre($nombre, $contrasena)
    {
        ...
        if ($usuario) {
            // Depurar la contraseña hash y la contraseña que está siendo verificada
            var_dump($contrasena, $usuario->contrasena, password_verify($contrasena, $usuario->contrasena));
