<?php
require_once '../tpe/app/modelos/ventas.modelo.php';
require_once '../tpe/app/vistas/ventas.vista.php';
...
class ControladorVentas
{
    ...
    public function mostrarVenta($id_venta, $id_cliente)
    {
        $venta = $this->modelo->obtenerVenta($id_venta);
        $cliente= $this->modeloCLientes->obtenerCliente($id_cliente);
        
        if ($venta) {
            return $this->vista->mostrarVenta($venta, $cliente);
