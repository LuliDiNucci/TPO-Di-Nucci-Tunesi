...
class VentasController
{
    ...
    {
        $venta = $this->model->getVenta($id_venta, $res->usuario);
    ...
    public function updateVenta($id_venta, $res)
    {
        ...
        $venta = $this->model->getVenta($id_venta, $res); 
        $clientes = $this->categoriasModel->getCategorias($res);
